          ...
          <div class="flex justify-between items-start ">
            <div>
              ...
              <p class="text-sm text-[#112211] text-opacity-75 mt-1 ">
                Inicio: {{
                  formatDateTextEs(props.item.startsAt) }}<br />
                Fin: {{ formatDateTextEs(props.item.endsAt) }}
              </p>
            </div>

            <div class="text-right font-poppins">
              <p class="text-sm text-[#112211] text-opacity-75 ">Paquete estándar</p>
              <p class="text-2xl font-extrabold text-orange">
                {{ item.price }} €
              </p>
              <p class="text-xs text-[#112211] text-opacity-75 text-nowrap ">Precio real aproximado</p>
            </div>
          </div>
