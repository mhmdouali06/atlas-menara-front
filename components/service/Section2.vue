    ...
    <div class="grid grid-cols-12">
      ...
      <div class="col-span-12 md:col-span-8 lg:col-span-9 py-10 px-4 md:pr-10 lg:pr-20">
        ...
        <p class="mt-4 text-[15px] leading-relaxed text-[#808080] font-poppins">
          ...
          viaje con tranquilidad, seguridad
          y al mejor precio.
          <br />
...
import left from "@/assets/img/global/left-service.png";
import ShipIcon from "@/assets/img/icon/shipIcon.svg";
import TicketIcon from "@/assets/img/icon/planeIcon.svg";
import BuildingOfficeIcon from "@/assets/img/icon/building.svg";
import AcademicCapIcon from "@/assets/img/icon/vise.svg";
const services = [
  {
    id: 1,
    title: "Billetes de avión",
    cta: "Descubrir",
    href: "/servicios#venta-de-billetes-aereos",

    icon: TicketIcon,
  },
  {
    id: 2,
    title: "Billetes de barco",
    cta: "Descubrir",
    href: "/servicios#billetes-de-barco-entre-algeciras-tarifa-y-tanger",
    icon: ShipIcon,
  },
  {
    id: 3,
    ...
    cta: "Descubrir",
    href: "/servicios#reserva-de-hoteles",
  ...
  },
  {
    ...
    title: "Visados",
    cta: "Descubrir",
    href: "/servicios#tramitacion-de-visados-umrah-y-turista",
