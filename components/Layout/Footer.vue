...
import badge from "@/assets/img/global/badge.jpg";

import inst from "@/assets/img/icon/orange_instagram.svg";
...
<template>
  <footer class="bg-orange text-white">
    <div class="mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
      <!-- Top: 4 columns -->
      <div
        class="grid grid-cols-1 gap-8 md:grid-cols-4 md:gap-10 lg:gap-14 items-start"
      >
        <!-- Col 1: Logo + Address -->
        <div class="space-y-4">
          <img
            :src="logo"
            alt="Atlas Menara"
            class="h-14 w-auto rounded-md bg-white p-2"
          />
          <p
            class="text-sm leading-relaxed opacity-90 font-poppins font-semibold"
          >
        ...
        <!-- Col 2: CONTACTO -->
        <div class="space-y-3">
          <h3 class="font-poppins font-bold text-lg">CONTACTO</h3>
          <div class="space-y-2">
            <a
              href="mailto:Info@Atlasmenara.Com"
              class="block hover:underline break-all"
              >Info@Atlasmenara.Com</a
            >
            <ul class="space-y-1 text-[15px]">
              <li>
                <a class="hover:underline" href="tel:+34657373150"
                  >• +34 657 373 150</a
                >
              </li>
              <li>
                <a class="hover:underline" href="tel:+34910648506"
                  >• +34 910 648 506</a
                >
              </li>
              <li>
                <a class="hover:underline" href="tel:+34692342055"
                  >• +34 692 342 055</a
                >
              </li>
            </ul>
...
<style scoped>
/* Optional: slight polish for lists on small screens */
@media (max-width: 480px) {
  ul.list-disc {
    margin-left: 1.25rem; /* keep bullets visible on tiny screens */
  }
}
</style>
