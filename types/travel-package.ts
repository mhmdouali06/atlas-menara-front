...
export type TravelPackageHotelInput = { name: string; name2?: string; map?: string }
export type TravelPackagePlanInput  = { dayNumber?: number; title: string; description: string }
